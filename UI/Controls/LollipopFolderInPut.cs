...
public class LollipopFolderInPut : Control
{
    ...
    private TextBox LollipopTB = new TextBox();
    ...
    private new bool Focus = false;
    private float SizeAnimation = 0;
    private float SizeInc_Dec;
    private float PointAnimation;
    private float PointInc_Dec;
    private string fontColor = "#999999";
    private string focusColor = "#508ef5";
    private Color EnabledFocusedColor;
    private Color EnabledStringColor;
    private Color EnabledInPutColor = ColorTranslator.FromHtml("#acacac");
    private readonly Color EnabledUnFocusedColor = ColorTranslator.FromHtml("#dbdbdb");
    private readonly Color DisabledInputColor = ColorTranslator.FromHtml("#d1d2d4");
    private readonly Color DisabledUnFocusedColor = ColorTranslator.FromHtml("#e9ecee");
    private readonly Color DisabledStringColor = ColorTranslator.FromHtml("#babbbd");
