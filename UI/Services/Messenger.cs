...
namespace UI.Services
{
    ...
    {
        public NotifyAction Action { get; private set; }
    ...
    public class Messenger
    {
        ...
        private static Lazy<Messenger> _instance = new Lazy<Messenger>(() => new Messenger());

        /// <summary>
        /// Gets the single instance of the Messenger.
        /// </summary>
        public static Messenger Instance { get => _instance.Value; }
        ...
        public void Register<T>(object recipient, Action<T> action) => Register(recipient, action, null);
        ...
        public void Send<T>(T message) => Send(message, null);
